...
implements ChannelPipelineFactory, ExternalResourceReleasable {
	...
	protected IOFConnectionListener connectionListener;
	...
	private void init(Timer timer,
			IOFConnectionListener connectionListener) {
	...
	public OpenflowPipelineFactory(Timer timer,
			IOFConnectionListener connectionListener) {
		super();
		init(timer, connectionListener);
		this.keyStore = null;
